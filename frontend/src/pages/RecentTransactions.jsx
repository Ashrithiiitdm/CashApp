                ...
                <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
                    {isLoading ? (
                                        ...
                                        {txns.map((txn) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span
                                                        className={`text-sm font-bold ${txn.type === "credit" ? "text-[#36a736]" : "text-gray-900"}`}
                                                    >
                                                        {txn.type === "credit"
                                                            ? "+"
                                                            : ""}{" "}
                        ...
                        <div className="flex flex-col items-center justify-center h-full py-20">
                            ...
                            <p className="text-gray-400 text-center text-xs max-w-[250px] leading-relaxed">
                                We couldn't find any transaction related to your
                                search. Please try another search term.
                            </p>
                        </div>
                    )}
                </div>
